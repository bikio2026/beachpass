    ...
    <Popup>
      <div className="w-64 font-sans">
        <div className="px-4 pt-4 pb-3">
          ...
          <div className="flex gap-3 mb-3">
            <div className="flex items-center gap-1.5">
              <Umbrella size={13} className="text-color-tier-basic" />
            ...
            <div className="flex items-center gap-1.5">
              <Crown size={13} className="text-color-tier-premium" />
              <span className="text-xs font-semibold text-color-text">
          ...
          <div className="w-full h-1.5 rounded-full bg-color-bg-input overflow-hidden mb-3">
            <div
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 px-4 py-2.5 text-xs font-semibold text-color-accent bg-color-accent-soft hover:bg-color-accent hover:text-white transition-all border-t border-color-border"
        >
          Ver detalle
