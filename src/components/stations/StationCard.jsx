...
export function StationCard({ station }) {
  ...
  return (
    <button
      onClick={handleClick}
      className="w-full text-left p-4 bg-bg-card rounded-xl border border-border hover:border-accent transition-all group"
    ...
    >
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          <Umbrella size={14} className="text-tier-basic shrink-0" />
          <AvailabilityBar
        ...
        <div className="flex items-center gap-2">
          <Crown size={14} className="text-tier-premium shrink-0" />
          <AvailabilityBar
