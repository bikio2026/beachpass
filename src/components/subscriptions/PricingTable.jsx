    ...
    return (
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6">
          <p className="text-sm text-text-muted mb-4">Iniciá sesión para suscribirte</p>
          <LoginForm />
        </div>
      </div>
    )
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          ...
          <button
            ...
            className="px-6 py-3 rounded-xl bg-accent text-white font-semibold text-sm hover:bg-accent-hover transition-colors"
      ...
      <div className="flex-1 overflow-auto p-6 pb-20 md:pb-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Basic */}
            <div className="bg-bg-card rounded-2xl border border-border p-6 flex flex-col"
              style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
              <div className="flex items-center gap-2 mb-4">
                <div className="w-10 h-10 rounded-xl bg-accent-soft flex items-center justify-center">
                  <Umbrella size={20} className="text-tier-basic" />
                </div>
                <div>
                  <h3 className="font-display text-lg font-bold text-text">Basic</h3>
                  <p className="text-xs text-text-muted">Sombrilla compacta</p>
                </div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 rounded-xl border-2 border-accent text-accent font-semibold text-sm hover:bg-accent hover:text-white transition-all disabled:opacity-50"
              >
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl border-2 border-amber-200 p-6 flex flex-col relative overflow-hidden">
              <div className="absolute top-3 right-3">
                <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-sun text-white text-[10px] font-bold uppercase tracking-wider rounded-full">
                  <Zap size={10} /> Popular
                </span>
              </div>

              <div className="flex items-center gap-2 mb-4">
                <div className="w-10 h-10 rounded-xl bg-sun-soft flex items-center justify-center">
                  <Crown size={20} className="text-tier-premium" />
                </div>
                <div>
                  <h3 className="font-display text-lg font-bold text-text">Premium</h3>
                  <p className="text-xs text-text-muted">Sombrilla UV + tumbonas</p>
                </div>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 rounded-xl bg-sun text-white font-semibold text-sm hover:bg-sun-hover transition-all disabled:opacity-50"
